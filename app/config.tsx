...
export const config = {
    ...
    inferenceModel: 'gpt-3.5-turbo', // Groq: 'llama3-70b-8192' ,'mixtral-8x7b-32768', 'gemma-7b-it' // OpenAI: 'gpt-3.5-turbo', 'gpt-4' // Ollama 'mistral', 'llama3' etc
    ...
    textChunkOverlap: 100, // Recommended to decrease for Ollama
    numberOfSimilarityResults: 5, // Number of similarity results to return per page
    ...
    embedSources: true, // Add this line
    language: 'fr' // Add language configuration
